...
@section('content')
    ...
    <div class="form-group has-feedback">
        ...
        {{ Form::text('pedido', old('pedido'), array('class'=>'form-control','placeholder'=>'Número do Pedido', 'maxlength' => '10')) }}
    ...
    <div class="form-group has-feedback">
        ...
        {{ Form::text('nome', old('nome'), array('class'=>'form-control','autofocus'=>'autofocus', 'placeholder'=>'Nome do cliente', 'maxlength' => '50')) }}
    ...
    <div class="form-group has-feedback">
        ...
        {{ Form::text('titulo', old('titulo'), array('class'=>'form-control','autofocus'=>'autofocus', 'placeholder'=>'Título', 'maxlength' => '100')) }}
    ...
    <div class="form-group has-feedback">
        ...
        <?php echo $errors->first('observacao'); ?>
    </div>
